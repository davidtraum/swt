...
void RouteInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RouteInterface *_t = static_cast<RouteInterface *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (RouteInterface::*_t)(QString );
...
const QMetaObject RouteInterface::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_RouteInterface.data,
      qt_meta_data_RouteInterface,  qt_static_metacall, nullptr, nullptr}
};
