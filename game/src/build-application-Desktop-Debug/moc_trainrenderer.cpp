...
void TrainRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TrainRenderer *_t = static_cast<TrainRenderer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TrainRenderer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrainRenderer.data,
      qt_meta_data_TrainRenderer,  qt_static_metacall, nullptr, nullptr}
};
