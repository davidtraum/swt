...
#include "../application_server/infowidget.h"
...
QT_MOC_LITERAL(1, 11, 14), // "sendInfoSignal"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "InfoWidget\0sendInfoSignal\0"
};
...
void InfoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendInfoSignal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (InfoWidget::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoWidget::sendInfoSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InfoWidget::sendInfoSignal(int _t1, int _t2)
{
